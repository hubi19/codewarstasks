...
#  and smashes them together into a sentence and returns
#  the sentence. You can ignore any need to sanitize words
#  or add punctuation, but you should add spaces
#  between each word. Be careful, there shouldn't be
